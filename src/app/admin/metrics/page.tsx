...
export default function MetricsPage() {
    ...
    const columns = [
        { header: "Metric Value", accessorKey: "value" as keyof typeof dummyMetrics[0], className: "font-medium text-gray-900" },
        { header: "Label / Description", accessorKey: "label" as keyof typeof dummyMetrics[0] },
        {
            header: "Actions",
