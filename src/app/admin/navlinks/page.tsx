...
export default function NavLinksPage() {
    ...
    const columns = [
        { header: "Display Order", accessorKey: "order" as keyof typeof dummyLinks[0], className: "text-gray-500 w-[100px]" },
        { header: "Label", accessorKey: "label" as keyof typeof dummyLinks[0], className: "font-medium text-gray-900" },
        { header: "Destination URL", accessorKey: "url" as keyof typeof dummyLinks[0], className: "font-mono text-gray-500" },
        {
            header: "Actions",
