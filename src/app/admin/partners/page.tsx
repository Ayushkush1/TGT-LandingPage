...
export default function PartnersPage() {
    ...
    const columns = [
        { header: "Partner/Client Name", accessorKey: "name" as keyof typeof dummyPartners[0], className: "font-medium text-gray-900 w-[300px]" },
        { header: "Logo URL", accessorKey: "logoUrl" as keyof typeof dummyPartners[0], className: "text-gray-500 font-mono text-sm" },
        {
            header: "Actions",
