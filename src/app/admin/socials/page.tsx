...
export default function SocialLinksPage() {
    ...
    const columns = [
        { header: "Platform", accessorKey: "platform" as keyof typeof dummySocials[0], className: "font-medium text-gray-900" },
        {
            header: "URL",
            accessorKey: (row: typeof dummySocials[0]) => (
                <a href={row.url} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-brand-navy hover:underline">
