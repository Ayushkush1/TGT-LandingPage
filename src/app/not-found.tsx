  ...
  return (
    <div className="w-full flex-1 bg-white flex items-center justify-center relative overflow-hidden font-sans py-32 md:py-48">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-xl">
        ...
        <Link 
          href="/" 
          className="group relative inline-flex items-center justify-center px-8 py-3.5 text-sm font-medium text-white bg-[#0f2824] hover:bg-[#0f2824]/90 rounded-full overflow-hidden transition-all duration-300 ease-out"
        >
