...
function AccessibilityServices() {
  ...
  const accessibilityServices = serviceData?.["accessibility-services"];
  ...
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={accessibilityServices?.hero} />
      <TrustedBy />
      <ServicesAccordion serviceData={accessibilityServices?.services} />
