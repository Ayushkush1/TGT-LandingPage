...
function BusinessIntelligenceSolutions() {
  ...
  const businessIntelligenceSolutions =
    serviceData?.["business-intelligence-solutions"];
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={businessIntelligenceSolutions?.hero} />
      <TrustedBy />
      <ServicesAccordion
        serviceData={businessIntelligenceSolutions?.services}
      />
