...
function BusinessSoftwareSolutions() {
  ...
  const businessSoftwareSolutions =
    serviceData?.["business-software-solutions"];
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={businessSoftwareSolutions?.hero} />
      <TrustedBy />
      <ServicesAccordion serviceData={businessSoftwareSolutions?.services} />
