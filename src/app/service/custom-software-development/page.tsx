...
function CustomSoftwareDevelopment() {
  ...
  const customSoftwareDevelopment =
    serviceData?.["custom-software-development"];
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={customSoftwareDevelopment?.hero} />
      <TrustedBy />
      <ServicesAccordion serviceData={customSoftwareDevelopment?.services} />
