...
function DigitalMarketing() {
  ...
  const digitalMarketing = serviceData?.["digital-marketing"];
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={digitalMarketing?.hero} />
      <TrustedBy />
      <ServicesAccordion serviceData={digitalMarketing?.services} />
