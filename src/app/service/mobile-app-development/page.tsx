...
function MobileAppDevelopment() {
  ...
  const mobileAppDevelopment = serviceData?.["mobile-app-development"];
  ...
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={mobileAppDevelopment?.hero} />
      <TrustedBy />
      <ServicesAccordion serviceData={mobileAppDevelopment?.services} />
