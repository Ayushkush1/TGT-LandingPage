...
function WebsiteDesignDevelopment() {
  ...
  const websiteDesignDevelopment = serviceData?.["website-design-development"];
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-brand-gold/20">
      ...
      <Navbar />
      <HeroSection serviceData={websiteDesignDevelopment?.hero} />
      <TrustedBy />
      <ServicesAccordion serviceData={websiteDesignDevelopment?.services} />
