            ...
            >
                ...
                <div className="flex flex-col xl:flex-row justify-between gap-12 relative z-10">
                    ...
                    <div className="space-y-4 max-w-5xl">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold tracking-wider text-xl">THE GOLD TECHNOLOGIES</span>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 text-sm text-gray-400">
                            <div className="space-y-4">
                                <p className="text-gray-400 font-light leading-relaxed max-w-md text-sm">
                                    Empowering visionaries with cutting-edge digital solutions. We turn complex challenges into elegant, scalable technology.
                                </p>
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs text-gray-300">
                                    ...
                                    <span className="font-medium">Operating Worldwide • {time}</span>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p>SD-369, D block, Shastri Nagar,<br />Ghaziabad, Uttar Pradesh, India - 201002</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <MapPin className="w-4 h-4 text-[#D4AF37] mt-1 shrink-0" />
                                    <div>
                                        ...
                                        <p>Accessible minds 1309- Coffeen Avenue,<br />STE 1200 Sheridan Wyoming- 82801, USA</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-white">info@thegoldtechnologies.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-16 md:gap-24">
                        <div className="flex flex-col gap-4">
                            <h4 className="text-[#D4AF37] font-serif italic text-lg mb-2">Explore</h4>
                        ...
                        <div className="flex flex-col gap-4">
                            <h4 className="text-[#D4AF37] font-serif italic text-lg mb-2">Legal</h4>
                            <a href="#" className="text-gray-400 hover:text-white transition-colors">Privacy Policy</a>
                            <a href="#" className="text-gray-400 hover:text-white transition-colors">Terms of Use</a>
                            <span className="text-[10px] border border-gray-600 px-2 py-0.5 rounded text-gray-500 mt-2 w-fit">DMCA PROTECTED</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex items-center justify-center py-12 relative z-10 pointer-events-none select-none">
                    <div className="relative">
                        <span className="absolute -top-2 md:top-2 left-2 md:-left-10 text-sm font-bold tracking-[0.5em] text-white/20 mix-blend-overlay">THE</span>
                        ...
                        <span className="absolute bottom-0 md:bottom-2 right-2 md:-right-36 text-sm font-bold tracking-[0.5em] text-white/20 mix-blend-overlay">NOLOGIES</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 pt-8 border-t border-white/5">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        <p className="text-gray-500 text-sm">© 2026 The Gold Technologies.</p>

                        {/* Women Owned Badge (Small) */}
                        <div className="flex items-center gap-1 opacity-70 grayscale hover:grayscale-0 transition-all">
                            <span className="text-xs font-bold text-white">W<span className="text-pink-500">✿</span>MEN OWNED</span>
                        </div>
                    </div>
