...
export const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`w-full py-6 px-4 md:px-8 lg:px-12 flex items-center justify-between sticky top-0 z-50 transition-all duration-300 ${
        scrolled ? "backdrop-blur-xl bg-white/80 shadow-sm" : "bg-transparent"
      }`}
    >
      {/* Logo */}
      <motion.div
