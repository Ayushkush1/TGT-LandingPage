...
const projects = [
    { id: 1, title: "FinTech Evolution", category: "System Architecture", theme: "bg-zinc-900" },
    { id: 2, title: "Luxe Commerce", category: "Digital Experience", theme: "bg-stone-800" },
    { id: 3, title: "Health OS", category: "Platform Design", theme: "bg-neutral-900" },
    { id: 4, title: "Urban Real Estate", category: "Web Interface", theme: "bg-slate-900" },
    { id: 5, title: "Future Social", category: "Mobile Ecology", theme: "bg-black" },
];
                            ...
                            >
                                ...
                                <div className="relative w-full h-full p-6 flex flex-col justify-between z-10">
                                    ...
                                    <div className="transform transition-transform duration-300 group-hover:translate-y-[-4px]">
                                        <p className="text-[11px] font-normal uppercase  text-white/80 group-hover:text-white/80 transition-colors duration-300">{project.category}</p>
