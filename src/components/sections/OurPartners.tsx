  ...
  <>
    ...
    <LogoPlaceholder className="w-56">
      <div className="text-3xl font-bold flex flex-col items-center leading-none">
        <span className="text-white tracking-tighter">
          absolute<span className="text-[#F58220]">factor</span>
          <sup className="text-xs text-gray-400">®</sup>
        </span>
        <span className="text-[0.5rem] uppercase tracking-widest text-gray-400 mt-1">
    ...
    <LogoPlaceholder className="w-48">
      <div className="flex items-center gap-2">
        ...
        <span className="text-4xl font-extralight text-white tracking-wide">
          dalxes
        </span>
      </div>
    </LogoPlaceholder>
    ...
    <LogoPlaceholder className="w-48">
      <div className="flex flex-col items-center">
        <div className="relative w-12 h-12 mb-1">
          <span className="absolute inset-0 text-[#2E3092] font-bold text-4xl">
            A
          </span>
          <span className="absolute inset-0 text-[#2E3092] font-bold text-4xl left-0 top-0 translate-x-2 translate-y-1 opacity-50">
            M
          </span>
        </div>
        <span className="text-[0.7rem] font-bold text-white uppercase leading-tight text-center">
          Accessible
          <br />
          Minds
        </span>
    ...
    <LogoPlaceholder className="w-52">
      <div className="flex items-center">
        <div className="relative w-10 h-10 mr-2">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-[#1B1464] font-bold text-sm">
            C
          </div>
        </div>
        <div className="flex flex-col">
          <span className="text-2xl font-black text-white tracking-tight">
            ENTR<span className="text-pink-500">ii</span>K
          </span>
          <span className="text-[0.4rem] text-gray-400 uppercase tracking-wider text-center w-full block">
            EMPOWERING CREATIVITY, ENFORCING RIGHTS
          </span>
        </div>
      </div>
    </LogoPlaceholder>
    ...
    <LogoPlaceholder className="w-28">
      <div className="relative w-16 h-16 bg-white flex items-center justify-center border-4 border-gray-400 rounded-sm">
        <span className="text-[#0071BC] font-black text-5xl absolute -top-1 left-1 z-10">
          T
        </span>
        <span className="text-black font-black text-5xl absolute bottom-0 right-1 drop-shadow-md">
          S
        </span>
      </div>
    </LogoPlaceholder>
