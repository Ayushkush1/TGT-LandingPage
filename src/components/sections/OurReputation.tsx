...
const testimonials = [
  {
    id: 1,
    quote:
      "Working with The Gold Technologies was a game-changer. They delivered a stunning, high-performance platform that exceeded all our expectations.",
    name: "Sarah Mitchell",
    role: "CEO, InnovateCo",
  ...
  },
  {
    id: 2,
    quote:
      "The team's attention to detail and commitment to quality is unmatched. Our app launch was seamless and our users love it.",
    name: "Michael Torres",
  ...
  },
  {
    id: 3,
    quote:
      "Exceptional quality and speed these are key. They understood our vision perfectly and delivered beyond expectations.",
    name: "David Chen",
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 font-light leading-relaxed max-w-2xl mx-auto mt-6">
              Hear from our partners who have successfully transformed their
              businesses with our innovative digital solutions.
            </p>
          </div>
