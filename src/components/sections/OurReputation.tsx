...
const testimonials = [
    {
        id: 1,
        quote: "TGT Transformed our outdated system into a modern, efficient web app. Their team is simply amazing!",
        name: "John Doe",
        role: "CEO, FinTech Co.",
    ...
    {
        id: 2,
        quote: "The strategic insights and technical execution were flawless. A true partner in our digital growth.",
        name: "Sarah Miller",
