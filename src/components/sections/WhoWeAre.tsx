...
export const WhoWeAre = ({ data: propData }: { data?: any }) => {
  ...
  return (
    <AnimatedSection animation="fadeUp" delay={0.15}>
      <section className="py-12 md:py-24 px-4 md:px-12 bg-white relative z-0">
        <div className="max-w-7xl mx-auto space-y-12 md:space-y-20">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="relative perspective-100 z-0">
              <div className="group rounded-[32px] md:rounded-[48px] p-4 sm:p-6 md:p-10 min-h-[360px] md:min-h-[480px] flex flex-col justify-end relative overflow-hidden transition-transform duration-500">
                {/* Floating Widget */}
                <div className="absolute top-4 left-2 right-2 sm:left-6 sm:right-6 md:top-12 md:left-10 md:right-10 transform -rotate-3 group-hover:-rotate-1 transition-all duration-500 z-20">
                  {/* Floating "Designer" Card */}
                  <div className="relative w-full z-20">
                    {/* Lime Container */}
                    <div className="bg-slate-800 rounded-[28px] md:rounded-[36px] p-2.5 sm:p-3 shadow-2xl transform transition-all duration-500 group-hover:-translate-y-2 group-hover:rotate-1">
                      {/* Inner White Glass Card */}
                      <div className="bg-white/95 backdrop-blur-xl rounded-[22px] md:rounded-[32px] p-4 sm:p-6 shadow-inner">
                        {/* Header */}
                        <div className="flex justify-between items-start mb-4 md:mb-8">
                          <div>
                            ...
                            <div className="text-xl md:text-2xl font-extrabold text-[#0B0F29]">
                              Scaling Up
                            </div>
                          </div>
                          <div className="h-8 w-8 md:h-10 md:w-10 bg-gray-50 rounded-full flex items-center justify-center border border-gray-100">
                            <TrendingUp className="w-4 h-4 md:w-5 md:h-5 text-[#0B0F29]" />
                          </div>
                        </div>
                      ...
                      <div className="px-4 md:px-6 py-2 md:py-3 flex justify-between items-center">
                        <span className="text-[10px] md:text-xs font-bold text-white uppercase tracking-widest opacity-80">
                          The Gold Technologies
                        </span>
                        <Users className="w-3.5 h-3.5 md:w-4 md:h-4 text-white opacity-80" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Background Graphic */}
                <div className="grid grid-cols-5 gap-2 md:gap-4 items-end h-48 md:h-72 rounded-2xl md:rounded-3xl w-[110%] mt-20 md:mt-32 px-6 md:px-14 pb-3 md:pb-5 ml-[-5%] opacity-100 relative bg-gray-50/90">
            ...
            <div className="space-y-4 md:space-y-8">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold w-full max-w-[380px] text-gray-900 leading-tight">
                {data?.block1Headline}
              </h3>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            {/* Right: Graphic */}
            <div className="relative order-1 lg:order-2 perspective-1000 z-0">
              <div className="p-4 sm:p-6 md:p-10 min-h-[380px] md:min-h-[520px] flex items-center justify-center relative overflow-hidden transition-transform duration-500 group">
                {/* Floating Card - Tech Specs */}
                <div className="absolute top-4 left-2 sm:left-6 md:top-9 md:left-10 z-20 bg-gray-900 p-5 md:p-8 rounded-[24px] md:rounded-[32px] text-white w-[260px] sm:w-80 shadow-2xl transform rotate-[3deg] group-hover:rotate-0 transition-all duration-500 cursor-pointer">
                  <div className="flex justify-between items-center mb-4 md:mb-6">
                    <div className="flex items-center gap-2 md:gap-3">
                      ...
                      <div className="text-xs md:text-sm font-bold opacity-90 tracking-wide uppercase">
                        System Status
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 md:space-y-4">
                    <div className="bg-white/10 rounded-xl p-3 md:p-4 backdrop-blur-sm">
                      <div className="flex justify-between items-center mb-1.5 md:mb-2">
                        ...
                        <span className="text-[10px] md:text-xs font-bold bg-[#D4AF37] text-black px-1.5 md:px-2 py-0.5 rounded">
                          PASSED
                        </span>
                      </div>
                ...
                <div className="absolute top-6 right-2 sm:right-6 md:top-20 md:right-20 z-30 bg-[#0B0F29] p-2.5 md:p-4 rounded-full shadow-2xl animate-bounce duration-[3000ms]">
                  <Server className="w-4 h-4 md:w-6 md:h-6 text-[#D4AF37]" />
                </div>
                <div className="absolute bottom-28 left-1 sm:left-4 md:bottom-40 md:left-10 z-30 bg-[#D4AF37] p-2.5 md:p-4 rounded-full shadow-2xl animate-bounce delay-700 duration-[4000ms]">
                  <Zap className="w-4 h-4 md:w-6 md:h-6 text-[#0B0F29]" />
                </div>

                {/* Bottom Card - UX Score */}
                <div className="absolute bottom-2 right-0 sm:right-5 bg-white p-4 sm:p-6 md:p-8 rounded-[24px] md:rounded-[32px] shadow-xl -rotate-3 border border-gray-50 w-[290px] sm:w-[360px] md:w-[420px] z-10 transition-transform group-hover:rotate-0 duration-500">
                  <div className="flex gap-3 sm:gap-6 items-center mb-3 md:mb-6">
                    <div className="relative w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 flex-shrink-0">
                      <svg
                        viewBox="0 0 36 36"
                        className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 transform -rotate-90"
                      >
                        <path
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <span className="text-[9px] sm:text-xs font-bold text-gray-400 uppercase tracking-widest mt-0.5 md:mt-1">
                          Score
                        </span>
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="text-base sm:text-xl md:text-2xl font-bold text-gray-900 mb-1 md:mb-2 truncate">
                        User Experience
                      </div>
                      ...
                      <div className="text-xs md:text-sm text-gray-400 font-medium line-clamp-2 md:line-clamp-none">
                        Consistently rated excellent by enterprise clients.
                      </div>
                    </div>
                  </div>
                  <div className="space-y-2 md:space-y-3 pt-3 md:pt-6 border-t border-gray-100">
