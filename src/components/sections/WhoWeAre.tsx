                      ...
                      <div className="bg-white/95 backdrop-blur-xl rounded-[32px] p-6 shadow-inner">
                        ...
                        <div className="flex justify-between items-start mb-8">
                          <div>
                            ...
                            <div className="text-2xl font-extrabold text-[#0B0F29]">
                              Scaling Up
                            </div>
                          </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-xs font-bold bg-[#D4AF37] text-black px-2 py-0.5 rounded">
                          PASSED
                        </span>
                      </div>
                  ...
                  <div className="flex gap-6 items-center mb-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-1.5 mb-2">
                        {[1, 2, 3, 4, 5].map((s) => (
                          <span key={s} className="text-[#FFB800] text-sm">
                            ★
                          </span>
                        ))}
                      </div>
